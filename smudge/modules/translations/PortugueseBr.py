...
INSULTS_STRINGS = (
    ...
    "Se eu quisesse me matar, escalaria seu ego e pularia para o seu QI.",
    "Os zumbis comem cérebros você está safe.",
    "Você não evoluiu dos macacos, eles evoluíram de você.",
    "Volte e fale comigo quando o seu QI. excede a sua idade.",
    ...
    "Não sei o que o torna tão estúpido, mas realmente funciona.",
    "Continue falando, um dia você dirá algo inteligente! (eu duvido)",
    "Me surpreenda, diga algo inteligente.",
    ...
    "Me desculpe, eu magoei seus sentimentos quando te chamei de idiota. Eu pensei que você já sabia disso.",
    ...
    "Para de falar merda e pule na frente de um trem-bala.",
    ...
    "Pare de inalar oxigênio.",
    "Deus estava procurando por você. Você deveria sair para conhecê-lo.",
    "Dê o seu 100%. Agora, vá doar sangue.",
    ...
    "Ofereça-se para o alvo em um campo de tiro.",
    "Tiros na cabeça são divertidos. Experimente um.",
    ...
    "Que tal você parar de respirar por um dia? Isso vai ser ótimo.",
    "Tente provocar um tigre enquanto vocês dois estão em uma gaiola.",
    "Você já tentou atirar em si mesmo a 100m usando uma câmera canon?",
    "Você deve tentar manter uma granada na boca e acendê-lo.",
    "Tente brincar de esconde-esconde com um leão, é divertido!",
    "Ouvi dizer que o phogine é venenoso, mas acho que você não se importará de inalá-lo por diversão.",
    "Vá ao espaço enquanto esquece o oxigênio na Terra.",
    "Você deve tentar jogar pique pega com cobras reais.",
    "Já tentou brincar de bang jump sem a corda? É muito legal!",
    "Verdade, vulcão é a melhor piscina para você.",
    "Você deveria tentar um banho quente em um vulcão.",
    "Tente passar um dia em um caixão e ele será seu para sempre.",
    "Bata Urânio com um nêutron lento na sua presença. Será uma experiência que vale a pena.",
    "Você pode ser a primeira pessoa a pisar no sol. Tente.",
)
...
"Filters_help": """
Torne o seu grupo mais animado com filtros; O bot responderá a certas palavras! Os filtros não diferenciam maiúsculas de minúsculas; toda vez que alguém disser suas palavras-chave, smudge responderá outra coisa! pode ser usado para criar seus próprios comandos, se desejado.
...
O recurso de configurações de backups do smudge permite que você configure rapidamente um grupo usando um modelo pré-existente. Em vez de definir as mesmas configurações repetidamente em grupos diferentes, você pode usar esse recurso para copiar a configuração geral entre grupos.
...
Observe que arquivos/fotos de outros bots não podem ser importados devido a restrições de Telegram.  Exceto Backups feitos no próprio smudge.
