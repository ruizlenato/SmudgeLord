...
func getMediaConfig(chatID int64) (bool, bool, bool, bool, error) {
	var mediasCaption, mediasAuto, mediasErrors, mediasArticle bool
	err := database.DB.QueryRow("SELECT mediasCaption, mediasAuto, mediasErrors, mediasArticle FROM chats WHERE id = ?;", chatID).Scan(&mediasCaption, &mediasAuto, &mediasErrors, &mediasArticle)
	return mediasCaption, mediasAuto, mediasErrors, mediasArticle, err
}
