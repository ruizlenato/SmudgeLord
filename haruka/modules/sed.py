...
from haruka import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, SUPPORT_USERS
    ...
    if sed_result and update.effective_message.reply_to_message:
        ...
        try:
            ...
            if check and check.group(0).lower() == to_fix.lower():
                update.effective_message.reply_to_message.reply_text(tld("There has been an unspecified error".format(update.effective_user.first_name)))
                return
